...
import Boy from '@/public/Boy-contact.png'
            ...
            <section className='w-1/2 h-full font-montserrat flex flex-col justify-center gap-10 px-10 lg:px-20 xl:px-30'>
                <div className='flex flex-col gap-10'>
                    ...
                    <motion.h1
                        ...
                        className='font-bold text-[#001715] text-xl lg:text-3xl xl:text-5xl'>Contact Us</motion.h1>
                    ...
                    <motion.p
                        ...
                        viewport={{ once: false, amount: 0.5 }}
                        className='text-[#565656] font-medium opacity-80 text-md lg:text-xl 2xl:text-4xl  leading-relaxed pb-20'> <span className='text-[#E13C5B]'>Have questions or need support? </span>Our dedicated team is always available to assist you with guidance, solutions and prompt help</motion.p>
